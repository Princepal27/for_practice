                ...
                <div class="sign-in-page inner-bottom-sm">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 sign-in">
                            ...
                            <form class="register-form outer-top-xs" method="post" action ="controller/usercontroller.php">
                        ...
                        <div class="col-md-6 col-sm-6 create-new-account">
                            ...
                            <form class="register-form outer-top-xs" role="form" method="post" name="register" onSubmit="return valid();" action="controller/usercontroller.php">
                                <div class="form-group">

...
// $con = mysqli_connect('localhost', 'root', '', 'onlineportal');
$obj = new portal;
					...
					<div class="content">
                        <div class="module">
							...
							<div class="module-body">
			                    ...
			                    <form class="form-horizontal row-fluid"  method="post" action="../controller/controller.php" enctype="multipart/form-data">
	                                ...
	                                <div class="control-group">
										<div class="controls">
											<button type="submit" name="insertproduct" class="btn">Insert</button>
										</div>
									</div>
								</form>
							</div>
